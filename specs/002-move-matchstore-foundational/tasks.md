...
- [ ] T001 Crear inventario base de dependencias de MatchStore en `specs/002-move-matchstore-foundational/checklists/dependency-audit.md` usando como fuente `specs/001-trivia-galatea-app/tasks.md`
- [ ] T002 [P] Crear mapeo antes/despues de tareas relocalizadas en `specs/002-move-matchstore-foundational/checklists/task-relocation-map.md` (ID, fase origen, fase destino, impacto)
- [ ] T003 [P] Documentar criterios de aceptacion de migracion (FR-001..FR-010) en `specs/002-move-matchstore-foundational/checklists/migration-acceptance.md`
...
- [ ] T004 Crear contrato `MatchStorePort` en `src/app/shared/foundational/state/match-store.port.ts` alineado con `specs/002-move-matchstore-foundational/contracts/matchstore-port.md`
- [ ] T005 Crear implementacion `MatchStoreService` encapsulada en `src/app/shared/foundational/state/match-store.service.ts` con Signals privados y API publica del puerto
...
- [ ] T009 [US1] Reubicar tarea de creacion de MatchStore desde fase US2 a fase Foundational en `specs/001-trivia-galatea-app/tasks.md` preservando ID original
- [ ] T010 [US1] Reubicar tarea de registro DI de MatchStore desde fase US2 a fase Foundational en `specs/001-trivia-galatea-app/tasks.md` preservando ID original
- [ ] T011 [US1] Actualizar dependencias explicitas de tarea US1 de navegacion/store para que dependa solo de tareas Foundational en `specs/001-trivia-galatea-app/tasks.md`
- [ ] T012 [US1] Ajustar checkpoint de Foundational para declarar disponibilidad de estado compartido antes de US1 en `specs/001-trivia-galatea-app/tasks.md`
- [ ] T013 [US1] Ajustar checkpoint de US1 para remover referencias a prerequisitos de US2 en `specs/001-trivia-galatea-app/tasks.md`
- [ ] T014 [US1] Actualizar seccion `Phase Dependencies` para declarar que US1 depende solo de Setup + Foundational en `specs/001-trivia-galatea-app/tasks.md`
- [ ] T015 [US1] Actualizar seccion `User Story Dependencies` para eliminar toda referencia US1 -> US2 por MatchStore en `specs/001-trivia-galatea-app/tasks.md`
...
- [ ] T016 [US2] Registrar mapeo final de tareas movidas (sin renumeracion global) en `specs/002-move-matchstore-foundational/checklists/task-relocation-map.md`
- [ ] T017 [P] [US2] Documentar justificacion de cada dependencia cambiada con referencia a FR-003 y FR-004 en `specs/002-move-matchstore-foundational/checklists/dependency-audit.md`
- [ ] T018 [US2] Validar y documentar preservacion de cobertura de SC-002 y SC-003 del backlog base en `specs/002-move-matchstore-foundational/checklists/migration-acceptance.md`
...
- [ ] T027 [P] Ejecutar revision final de formato checklist estricto (`- [ ] T### [P?] [US?] ...`) en `specs/002-move-matchstore-foundational/tasks.md`
- [ ] T028 [P] Verificar que no existan dependencias circulares entre fases en `specs/001-trivia-galatea-app/tasks.md`
- [ ] T029 Consolidar resumen ejecutivo de cambios de migracion para PR en `specs/002-move-matchstore-foundational/checklists/migration-acceptance.md`
- [ ] T030 Ejecutar validacion completa de quickstart de la feature 002 y registrar discrepancias en `specs/002-move-matchstore-foundational/quickstart.md`
